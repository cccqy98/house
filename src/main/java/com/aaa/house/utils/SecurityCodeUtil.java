...
public class SecurityCodeUtil {
    ...
    static final String accessKeyId = "LTAIGqOnfuSyG51u";   //改这里
    static final String accessKeySecret = "1yxwIRcFtek7Bp7iX0FaxfnrTG6dNH"; //改这里
    ...
    public static SendSmsResponse sendSms(String telephone, String code) throws ClientException {
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("找房网");  //改这里
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_171186309");  //改这里
